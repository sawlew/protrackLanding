    ...
    <div className='bg-[#F4F3FF] px-5 md:px-10 pt-20 text-center md:text-left'>
        <div className='md:flex justify-between items-start'>
            ...
            <div className='hidden md:block'>
                ...
                <div className='mt-5 flex'>
                    <input className='p-3 borderborder-gray-400 rounded-l-md rounded-r-none' type="text" placeholder='Get product updates' />
                    <button className='bg-[#5740EA] text-white p-3 px-5 rounded-r-md'>
        ...
        <div className='md:flex justify-between items-center md:mt-20 text-sm font-medium text-gray-800 md:border-t border-gray-300 py-10'>
            <div className='flex justify-center gap-5'>
                <div className='border border-gray-300 w-10 h-10 flex justify-center items-center rounded-full'>
