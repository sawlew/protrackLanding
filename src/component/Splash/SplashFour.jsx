...
import SplashBg4 from '../../assets/splash/splash4.png'

const SplashFour = () => {
  return (
    <div className='w-[80%] h-[80%] rounded-3xl grid grid-cols-2 items-center justify-center bg-white relative'>
    <div className='px-20'>
        <h1 className='text-2xl font-bold'>Build Stronger Client Relationships</h1>
        <p className='font-medium mt-8'>Keep all client information and communications in one place. Deliver exceptional service with ProTrack’s client management features</p>
    </div>
    <div className='h-[65%]'
    style={{
        backgroundImage: `url(${SplashBg4})`,
