...
import SplashBg2 from '../../assets/splash/splash2.png'

const SplashTwo = () => {
  return (
    <div className='w-[80%] h-[80%] rounded-3xl grid grid-cols-2 items-center justify-center bg-white relative'>
        <div className='px-20'>
            <h1 className='text-2xl font-bold'>Simplify your work, Amplify your Impact</h1>
            <p className='font-medium mt-8'>ProTrack empowers you to efficiently manage tasks, clients, finances, and collaborations—all in one place.</p>
        </div>
        <div className='h-[65%]'
        style={{
            backgroundImage: `url(${SplashBg2})`,
